...
traitFilePath="/project/voight_GWAS/wbone/PAD_and_CAD_Bivariate_scan/BMI_Pulit_data_rsID_ready.txt"
...
leadSNPsFilePath="/project/voight_GWAS/bychen9/ColocQuiaL/test_data/BMI_example_lead_SNP_file.txt"
...
setup_config_sh="/project/voight_GWAS/bychen9/ColocQuiaL/setup_config.sh"
...
setup_config_R="/project/voight_GWAS/bychen9/ColocQuiaL/setup_config.R"
